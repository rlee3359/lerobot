...
class IMLEConfig:
    ...
    Args:
        ...
        horizon: model action prediction size as detailed in `select_action`.
        n_action_steps: The number of action steps to run in the environment for one invocation of the policy.
            See `select_action` for more details.
        ...
        down_dims: Feature dimension for each stage of temporal downsampling in the modeling Unet.
            You may provide a variable number of dimensions, therefore also controlling the degree of
            downsampling.
        kernel_size: The convolutional kernel size of the modeling Unet.
